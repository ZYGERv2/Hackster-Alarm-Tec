...
void parseGPGGA(const char* GPGGAstr)
{
  ...
  if(GPGGAstr[0] == '$')
  {
    ...
    latitude=latitude_int+latitude_decimal*latModifier;
    ...
    longitude=longitude_int+longitude_decimal+lonModifier;
    
    //sprintf(buff, "latitude = %10.4f, longitude = %10.4f", latitude, longitude);
    String gpsResponse = "GPS:latitude=";
    Serial.println(gpsResponse+latitude+",longitude="+ longitude);
